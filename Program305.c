//Accept file name from the user and display the contents of whole file and number of small characters in the file
...
int main()
{
	...
	printf("\nThere are %d small case characters in the file",iCount);
